...
# on trouve les carrés
# on sépare l'image en 4 zones (une par ligne de carré)
# on trouve la distance moyenne entre les carrés, on élimine ceux qui sont pas dans cette 'moyenne'

out = open("places_detection_output.yml","w+")

#img = cv2.imread("temp/places_detection_image.png")
img = cv2.imread("../test_input/images/img20.png") # 18 20 21
#img = cv2.imread("test_input/images/others/INSA_PARK_5.png")
#img = cv2.imread("test_input/images/img_tel/test1.jpg")

img = cv2.resize(img, (650, 650))

lower = np.array([216, 216, 216], dtype = "uint8")
